...
# For GCP Secret Manager (optional)
try:
...
class GoogleMapsAPI:
    ...
    def _get_api_key(self) -> str:
        ...
        # If running on GCP, try Secret Manager
        if GCP_AVAILABLE and os.getenv("GOOGLE_CLOUD_PROJECT"):
            try:
                client = secretmanager.SecretManagerServiceClient()
                project_id = os.getenv("GOOGLE_CLOUD_PROJECT")
                secret_name = f"projects/{project_id}/secrets/google-maps-api-key/versions/latest"
